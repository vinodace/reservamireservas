      ...
      <div class="col-sm-12">
        <form action="confirm-booking.php" method="post">
          ...
          <div class="flight-result-box">
              <h1 class="main-subhding pb-2 mb-0">Passenger Information</h1>
          ...
          <div class="text-center mt-3">
              <button type="submit" name="confirm-booking" class="common-btn bg-success border-success">Proceed to Confirmation</button>
          </div>
        </form>
      </div>
    </div>
