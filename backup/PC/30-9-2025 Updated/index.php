          ...
          <div class="row">
            <div class="col-sm-12 mb-3">
              ...
              <div class="form-group"  data-lang="es">
                  <label><input type="radio" class="choose-trip-type" name="tripType" value="oneway" checked> De una sola mano</label>
                  <label><input type="radio" class="choose-trip-type" name="tripType" value="roundtrip"> Ida y vuelta</label>
              </div>    
            </div>
            <div class="col-sm-12">
