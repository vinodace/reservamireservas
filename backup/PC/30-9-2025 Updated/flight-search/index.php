        ...
        <div class="flightsidebar_filter-box_web2 pb-2 sticky-sidebar">
          <div class="flightsidebar_padding_web2">
            <div class="d-flex justify-content-between">
                ...
                <button id="clearFilters" class="bg-transparent main-wrap border-0">Clear Filters</button>
            </div>    
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 d-lg-flex flex-column justify-content-center text-center">
                        <div class="d-flex d-mb-block flex-column justify-content-between justify-content-md-center text-md-center">
                            ...
                            <a href="booking.php?offerId=<?= urlencode($offer['id']) ?>&adults=<?= $adults ?>&children=<?= $children ?>&infants=<?= $infants ?>&travel_class=<?= urlencode($travel_class) ?>" class="common-btn mt-0">Select</a>
                        </div>
        ...
        <?php
            ...
            <div class="col-sm-12 col-md-12 mb-5" id="waiting-loader">
                <div class="search-formbox_web2 flightsidebar_filter-box_web2">
                  ...
                  <img src="<?= $root_path ?>assets/images/loader.gif" alt="loader" class="search-form-loader mt-4">
                  ...
                  <a href="tel:<?= htmlspecialchars($phone_number_web4 ?? '') ?>" class="search-form-callbtn"><i class="fa-solid fa-phone-volume"></i> Call Us <?= htmlspecialchars($phone_number_web4 ?? '') ?></a>
                </div>
            </div>
        <?php endif; ?>
      </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="d-flex justify-content-center align-items-md-center gap-4 pb-3">
          <div class="w-50">
            <h1 class="modal-search-form-name text-center"><?php echo $origin_name; ?> (<?php echo $origin; ?>) </h1>
          </div>  
          <h1 class="modal-search-form-icon text-center"> <i class="fa-solid fa-arrow-right-long"></i></h1>
          <div class="w-50">
            <h1 class="modal-search-form-name text-center"><?php echo $destination_name; ?> (<?php echo $destination; ?>)</h1>
          </div>  
        </div>
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="modal-price-deal">
                ...
                <h1 class="main-hding mb-0 main_color_web2">$260<sup>*</sup></h1>
                <p class="modal-price-per-person">Price Per Adult</p>
              </div>
            </div>
          </div>
        </div>
        <a href="tel:<?php echo $phone_number_us; ?>" class="modal-call-btn"><i class="fa-solid fa-phone-volume"></i> Call Us <?php echo $phone_number_us; ?></a>
