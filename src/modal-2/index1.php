            ...
            <div class="content-center">
                <div class="modal-body">
                        ...
                        <div class="position-relative mx-auto d-table pt-4">
                            <div class="calling-main-btn">
                                <div class="calling-btn-img">
                                    <img src="images/helping-team.png" alt="">
                                </div>
                    ...
                    <div class="calling-box">
                        <div>
                            <a href="tel:<?php echo $phoneNumber; ?>" class="calling-box-btn">Call Now</a>
                            <p class="calling-box-txt">
                                <strong>To Book New Flight</strong>, Make Changes or Cancel Your Existing Flight
                            </p>
                        </div>
                    </div>
                    <img src="images/expedia-logo.svg" alt="" class="airline-modal-logo">
                    <a href="tel:<?php echo $phoneNumber; ?>" class="calling-btn"><i class="fa-solid fa-phone-volume"></i> <?php echo $phoneNumber; ?></a>
